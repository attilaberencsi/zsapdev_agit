...
define view entity ZC_BANKADDRESSTP
  ...
  association [1..1] to I_BANKADDRESSTP as _BaseEntity on $projection.BANKCOUNTRY = _BaseEntity.BANKCOUNTRY and $projection.BANKINTERNALID = _BaseEntity.BANKINTERNALID
{
  ...
  @Endusertext: {
    ...
    Quickinfo: 'Complete Number: Dialing Code+Number+Extension'
  }
  ...
  @Endusertext: {
    ...
    Quickinfo: 'E-Mail Address'
  }
  EmailAddress,
  _Country,
  _FormOfAddress,
  _Region,
  _Bank : redirected to parent ZC_BANKTP,
  _BankScriptVariant : redirected to composition child ZC_BANKSCRIPTEDADDRESSTP,
  _BaseEntity
}
